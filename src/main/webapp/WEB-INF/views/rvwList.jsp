...
<div style="text-align:center">
    <div class="board-container">
        <div class="search-container">
            ...
            <button id="writeBtn" class="btn-write" onclick="location.href='<c:url value="/review/write"/>'"><i class="fa fa-pencil"></i> 작성하기</button>
        </div>

        <table>
            <tr>
                <th class="rvw_no">번호</th>
                <th class="rvw_ttl">제목</th>
                <th class="content">내용</th>
                <th class="wrt_nm">작성자</th>
                <th class="img_pth">이미지</th>
                <th class="rvw_reg_date">등록일</th>
                <th class="rvw_vcnt">조회수</th>
                <th class="lk_cnt">좋아요</th>
            </tr>
            <c:forEach var="rvwDto" items="${list}">
                <tr>
                    ...
                    <c:choose>
                        <c:when test="${rvwDto.rvw_reg_date.time >= startOfToday}">
                            <td class="regdate"><fmt:formatDate value="${rvwDto.rvw_reg_date}" pattern="HH:mm" type="time"/></td>
                        </c:when>
                        <c:otherwise>
                            <td class="regdate"><fmt:formatDate value="${rvwDto.rvw_reg_date}" pattern="yyyy-MM-dd" type="date"/></td>
                        </c:otherwise>
                    </c:choose>
                    <td class="조회수">${rvwDto.rvw_vcnt}</td>
                    <td class="좋아요">${rvwDto.lk_cnt}</td>
                </tr>
            </c:forEach>
        </table>
        <br>
