            ...
            <div class="board">
                ...
                <div class="prd_detail_input_form">
                    <form action="<c:url value='/product/detail/insert'/>" method="post">
                        <input type="text" name="prd_dtl_cd" placeholder="상품상세코드" value="${param.prd_cd}" class="input_prd"/><br>
                        <input type="text" name="prd_cd" value="${param.prd_cd}" placeholder="상품코드" readonly="readonly" class="input_prd"/><br>
                        <input type="text" name="prd_str_prc" value="${param.prd_str_prc}" placeholder="상품시작가격" readonly="readonly" class="input_prd"/><br>
                        <input type="text" name="arl_nm" placeholder="항공사명" class="input_prd"/><br>
                        <input type="text" name="min_stt_cnt" placeholder="최소출발인원" class="input_prd"/><br>
                        <input type="text" name="max_stt_cnt" placeholder="최대출발인원" class="input_prd"/><br>
                        <input type="date" name="dpr_date" placeholder="출발일" class="input_prd"/><br>
