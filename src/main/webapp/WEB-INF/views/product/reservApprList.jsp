            ...
            <div class="board">
                ...
                <c:forEach var="usrInfo" items="${list}">
                    <div class="board_body">
                        ...
                        <div class="apprv_btn_box col5">
                            <button class="apprBtn">승인</button>
                ...
                <div class="pagingbox">
                    <c:if test="${ph.showPrev eq 'true'}">
                        <a href="<c:url value="/reserv/admin?page=${ph.beginPage-1}"/>"><span>&lt;</span></a>
                    </c:if>
                    <c:forEach var="i" begin="${ph.beginPage}" end="${ph.endPage}">
                        <a href="<c:url value='/reserv/admin?page=${i}'/>"><span>${i}</span></a>
                    </c:forEach>
                    <c:if test="${ph.showNext eq 'true'}">
                        <a href="<c:url value="/reserv/admin?page=${ph.endPage+1}"/>"><span>&gt;</span></a>
                    </c:if>
                </div>
            </div>
        </div>
