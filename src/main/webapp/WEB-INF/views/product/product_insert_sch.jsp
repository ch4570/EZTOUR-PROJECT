            ...
            <div class="board">
                ...
                <div class="prd_sch_input_form">
                    <form action="<c:url value='/product/insert/schedule'/>" method="post">
                        <input type="text" name="prd_cd" placeholder="상품코드" value="${param.prd_cd}" class="input_prd"/><br>
                        <input type="text" name="trv_date" placeholder="여행일차" class="input_prd"/><br>
                        <input type="text" name="sch_ord" placeholder="일정순번" class="input_prd"><br>
                        <input type="text" name="st_name" placeholder="관광지이름" class="input_prd"/><br>
                        <textarea name="sit_sh_desc" placeholder="관광지 간략설명" id="sit_sh_desc" cols="22" rows="5"></textarea><br>
                        <textarea name="sit_lo_desc" placeholder="관광지 상세설명" id="sit_lo_desc" cols="22" rows="5"></textarea><br>
                        <input type="text" name="sit_lo_desc" placeholder="관광지 상세설명" class="input_prd"/><br>
                        <input type="text" name="ht_inf" placeholder="호텔정보" class="input_prd"/><br>
                        <input type="text" name="brk" placeholder="아침" class="input_prd"/><br>
                        <input type="text" name="luh" placeholder="점심" class="input_prd"/><br>
                        <input type="text" name="din" placeholder="저녁" class="input_prd"/><br>
                        <input type="text" name="dstnc_tm" placeholder="이동소요시간" class="input_prd"/><br>
