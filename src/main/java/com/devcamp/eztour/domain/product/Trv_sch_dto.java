...
public class Trv_sch_dto {
    ...
    public Trv_sch_dto(String prd_cd, int trv_date, int sch_ord, String st_nm,
                       String sit_sh_desc, String sit_lo_desc, String ht_inf, String brk,
                       String luh, String din, String dstnc_tm) {
        this.prd_cd = prd_cd;
