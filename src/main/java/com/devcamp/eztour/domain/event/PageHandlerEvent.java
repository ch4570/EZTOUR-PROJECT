...
public class PageHandlerEvent {
    ...
    public PageHandlerEvent(int totalCnt, int page) {
    ...
    public PageHandlerEvent(int totalCnt, int page,int pageSize) {
        this.totalCnt = totalCnt;
        this.page = page;
        this.startList = (page - 1) * pageSize;
        totalPage = (int) Math.ceil((double) totalCnt / pageSize);
    ...
    public PageHandlerEvent(int totalCnt, int page,String search_option,String search_keyword) {
        this.totalCnt = totalCnt;
        this.page = page;
        this.startList = (page - 1) * pageSize;
        totalPage = (int) Math.ceil((double) totalCnt / pageSize);
    ...
    public PageHandlerEvent(int totalCnt, int page,String search_option,String search_keyword,int pageSize) {
        this.totalCnt = totalCnt;
        this.page = page;
        this.startList = (page - 1) * pageSize;
        totalPage = (int) Math.ceil((double) totalCnt / pageSize);
    ...
    public PageHandlerEvent(String search_option, String search_keyword) {
        this.search_option = search_option;
        this.search_keyword = search_keyword;
    }
}
