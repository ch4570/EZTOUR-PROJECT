...
//
//    @Override
//    public CustomerInquiryDto countCustomerInquiry(Integer qna_no) throws Exception {
//        return session.selectOne(namespace+"countCustomerInquiry");
//    }
//
//    @Override
...
//        return session.selectOne(namespace+"selectCustomerPage", map);
//    }
//
//    @Override
...
//    }
//    @Override
//    public deleteCustomerInquiry(Integer qna_no, String usr_id) throws Exception {
//        Map map = new HashMap();
